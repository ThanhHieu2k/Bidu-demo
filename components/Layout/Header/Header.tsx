            ...
            <div className={styles["search-wrap"]}>
                <div className={styles["search"] + '  grid'}>
                    <div className={styles["search-logo"]}>
                        <img className={styles["search-logo-navbar-icon"]} src="/images/navbar-icon.png"/>
                        <img className={styles["search-logo-repon"]} src="/images/logo-repon.png"/>
                        ...
                        <img className={styles["search-logo-search-icon"] } src="/images/navbar-search.png"/>
                        
                    </div>
                    
                    
                    <div className={styles["search-main"]}>
                        <input type="text" placeholder="Tìm kiếm" className={styles["search-main__input" ]}/>
